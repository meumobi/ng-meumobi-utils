...
/*! angular-onsenui.js for onsenui - v2.0.0-rc.17 - 2016-08-08 */
...
module.controller('LatestController', ["$scope", function($scope) { 
  this.items = [
    {
